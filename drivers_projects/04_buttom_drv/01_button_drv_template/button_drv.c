...
void register_button_operations(struct button_operations *opr)
{
    ...
    {
        device_create(button_class, NULL, MKDEV(major, i), NULL, "ebean_button%d", i);
    }
}
...
{
    major = register_chrdev(0, "ebean_button", &button_fops);

    button_class = class_create(THIS_MODULE, "ebean_button");
...
void button_exit(void)
{
    ...
    unregister_chrdev(major, "ebean_button");
}
